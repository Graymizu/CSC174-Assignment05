...
<body>
		...
		<nav class="menu">
			<ul>
				...
				<div class="people-menu">
					<li><a href="lulu.php">Lulu</a></li>
					<li><a href="anthony.php">Anthony</a></li>
					<li><a href="shareef.php">Shareef</a></li>
				</div>
			</ul>
		</nav>
	</div>
	...
	<div class="overview">
		...
		<div class="excerpt">
			...
			<p>My first major is CS. I knew that I was going to pursue this since coming to Rochester. I doing a BA with a focus on Human Computer Interaction.</p>

			<h3>Japanese</h3>

			<p>My second major is Japanese Language. I have always had an interest in the Japanese languade. When I first came to Rochester this started out as a minor, but I decided to go for the major when I realized that I didn't want to only focus on computer science.</p>
